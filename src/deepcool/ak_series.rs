//! Display driver for AK Series: AK400/500/620 DIGITAL & DIGITAL SE.

use super::{DeepCpu, Mode, AUTO_MODE_INTERVAL};
...
impl Display {
    pub fn new(cpu: DeepCpu, mode: &Mode, update: Duration, fahrenheit: bool, alarm: bool) -> Self {
